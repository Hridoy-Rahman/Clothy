...
const Collections = () => {
  return (
    <div className='bg-[url("https://i.ibb.co/wzh7pmR/collection-bg.png")] bg-cover bg-center bg-no-repeat xl:px-28 px-4 my-20'>
      <div className=" h-[580px]  flex justify-betweenflex-col md:flex-row items-center">
        <div className="md:w-1/2"></div>
        <div className="md:w-1/2">
          <img src="https://i.ibb.co/4Y9hXFV/zara-logo.png" alt="" />
